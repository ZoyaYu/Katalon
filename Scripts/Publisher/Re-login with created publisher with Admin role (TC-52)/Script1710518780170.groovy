...
WebUI.setText(findTestObject('Object Repository/Login Page/Login input field'), 'KatalonAdmin')

WebUI.setEncryptedText(findTestObject('Object Repository/Login Page/Password input field'), '4nvbrPglk7k=')
