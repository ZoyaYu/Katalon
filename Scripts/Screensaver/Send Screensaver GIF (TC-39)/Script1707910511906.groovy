...
WebUI.uploadFileWithDragAndDrop(findTestObject('Screensavers/Upload screensaver area'), 'C:\\Users\\Home\\git\\Katalon\\Imagesfortest\\minion.gif')
...
WebUI.setText(findTestObject('Pop-up Alerts page/Search by title field'), 'TC-39')

WebUI.verifyElementText(findTestObject('Pop-up Alerts page/Filtered sent alert'), 'TC-39')
