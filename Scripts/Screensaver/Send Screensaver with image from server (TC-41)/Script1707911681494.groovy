...
WebUI.setText(findTestObject('Pop-up Alerts page/Search by title field'), 'TC-41')

WebUI.verifyElementText(findTestObject('Pop-up Alerts page/Filtered sent alert'), 'TC-41')
