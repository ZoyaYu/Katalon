...
WebUI.setText(findTestObject('Create Pop-up Alert Page/Alert Title field'), 'TC-40')

WebUI.verifyElementPresent(findTestObject('Screensavers/Upload screensaver area'), 2)

WebUI.uploadFileWithDragAndDrop(findTestObject('Screensavers/Upload screensaver area'), 'C:\\Users\\Home\\git\\Katalon\\Imagesfortest\\earth.wmv')

WebUI.delay(5)

WebUI.getAttribute(findTestObject('Screensavers/uploaded screensaver file'), 'src')

WebUI.verifyElementVisible(findTestObject('Screensavers/uploaded screensaver file'))

WebUI.click(findTestObject('Wallpapers/Send wallpaper button'))

WebUI.waitForPageLoad(2)

WebUI.setText(findTestObject('Pop-up Alerts page/Search by title field'), 'TC-40')

WebUI.verifyElementText(findTestObject('Pop-up Alerts page/Filtered sent alert'), 'TC-40')
