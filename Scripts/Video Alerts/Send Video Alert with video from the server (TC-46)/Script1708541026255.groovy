...
WebUI.setText(findTestObject('Create Pop-up Alert Page/Alert Title field'), 'TC-46')
...
WebUI.setText(findTestObject('Pop-up Alerts page/Search by title field'), 'TC-46')

WebUI.verifyElementText(findTestObject('Pop-up Alerts page/Filtered sent alert'), 'TC-46')
