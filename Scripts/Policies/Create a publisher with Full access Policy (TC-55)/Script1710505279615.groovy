...
WebUI.setText(findTestObject('Publishers/Publisher name input field'), 'KatalonPublisher')
...
for (WebElement el : policies) {
    ...
    if (el.getText().equals('FullAccess')) {
        el.click()
...
WebUI.setText(findTestObject('Pop-up Alerts page/Search by title field'), 'KatalonPublisher')

WebUI.delay(5)

WebUI.verifyElementText(findTestObject('Publishers/filtered publisher'), 'KatalonPublisher')
