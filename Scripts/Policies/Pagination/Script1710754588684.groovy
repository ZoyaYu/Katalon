...
TestObject testObj = findTestObject('Object Repository/Publishers/Policies/Publisher list table')

'Find all publishers in a list'
List<WebElement> publishers = WebUI.findWebElements(testObj, 10)

println(publishers.size())
