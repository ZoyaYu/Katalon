...
WebUI.setText(findTestObject('Pop-up Alerts page/Search by title field'), 'FullAccess')

WebUI.delay(5)

WebUI.verifyElementText(findTestObject('Publishers/filtered publisher'), 'FullAccess')
